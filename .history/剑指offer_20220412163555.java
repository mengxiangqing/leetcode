...
class 剑指33 {
    public boolean verifyPostorder(int[] postorder) {
        ...
        if (postorder[n] < postorder[n - 1] && postorder[n] > postorder[left_index]
                && verifyPostorder(Arrays.copyOfRange(postorder, 0, left_index))
                && verifyPostorder(Arrays.copyOfRange(postorder, left_index + 1, n - 1)))
